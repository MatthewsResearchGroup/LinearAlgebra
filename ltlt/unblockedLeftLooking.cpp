...
void ltlt_unblockLL_s0(const matrix_view<double>& X, const row_view<double>& t, len_type k, bool first_column)
{
    PROFILE_FUNCTION
    auto n = X.length(0);
    matrix<double> temp_{n, 1};
...
void ltlt_unblockLL_s1(const matrix_view<double>& X, const row_view<double>& t, len_type k, bool first_column)
{
    PROFILE_FUNCTION
    auto n = X.length(0);
    matrix<double> temp_{n, 1};
